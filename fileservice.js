...
exports.walk = function (folder, options) {
	...
	// adapte les urls du répertoire courant qu'il soit généré maintenant ou récupéré du cache.
	...
	// flattenContent = flattenContent.map(item => { item.url = folder + '/' + item.url; return item; });
